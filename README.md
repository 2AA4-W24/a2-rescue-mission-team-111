...
# [A2] Island ca.mcmaster.se2aa4.island.team111.Explorer

- Authors:
  - [Omar, Ghoneim](ghoneimo@mcmaster.ca) 
  - [Marko, Popovic](popovm8@mcmaster.ca)
  - [Mazen, Hussain](hussam75@mcmaster.ca)

## Product Description

This product is an _exploration command center_ for the [Island](https://ace-design.github.io/island/) serious game. 

- The `ca.mcmaster.se2aa4.island.team_111_.Explorer` class implements the command center, used to compete with the others. (111 being the team identifier)
