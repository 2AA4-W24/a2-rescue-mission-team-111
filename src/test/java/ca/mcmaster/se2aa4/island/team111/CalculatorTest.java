...
class CalculatorTest {
    ...
    void calculateClosestNoCreeks(){
        Calculator calc = new Calculator(new ArrayList<POI>(), new POI("site", new Position(0, 0)));
    ...
    void calculateClosestWithCreeks(){
        ...
        Calculator calc = new Calculator(creeks, new POI("site", new Position(0, 0)));
    ...
    void testCheckDistance(){
        Calculator calc = new Calculator(null, new POI("site", new Position(0, 0)));
